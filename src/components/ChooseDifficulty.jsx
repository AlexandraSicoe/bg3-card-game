    ...
    >
      {difficultyState == 0 && (
        ...
        >
          ...
          >
            ...
            beginners. In this level, you'll encounter a small number of cards,
            making it easier to remember their positions and match them.
          </Typography>
        </Box>
      )}
      {difficultyState == 1 && (
      ...
      {difficultyState == 2 && (
        ...
        >
          ...
          >
            The Abyss level is the most challenging difficulty setting, designed
            for experienced players seeking a tough challenge. In this level,
            you'll face a large number of cards, testing your memory and
